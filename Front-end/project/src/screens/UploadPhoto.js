...
import UploadPhotoBreadcrumbElement from '../components/Breadcrumb/UploadPhotoBreadcrumbElement';
...
const UploadPhoto = () => {
  ...
  return (
    <div className='UploadPhoto'>
      <Container>
        <Col xs={12}>
          <UploadPhotoBreadcrumbElement />
          <h2 className='UploadPhotoTitle'>업로드</h2>
